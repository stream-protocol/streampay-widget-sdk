...
*/
    ...
    "laZXI": [function(require, module, exports) {
        ...
        const container = document.querySelector('#streampay-widget-container');
        const widget = new _index.StreamPay({
    ...
    "9DXHi": [function(require, module, exports) {
        var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
        parcelHelpers.defineInteropFlag(exports);
        parcelHelpers.export(exports, "StreamPay", () => StreamPay);
...
`;
        ...
        class StreamPay {
            ...
            startWindowHandling() {
                ...
                if (window) window.addEventListener('message', (event) => {
                    if (_helpers.isStreampayEvent(event)) {
    ...
    }, { "../helpers": "hyZmv", "../helpers/global": "hqJQc", "@parcel/transformer-js/src/esmodule-helpers.js": "gkKU3" }],
    "hyZmv": [function(require, module, exports) {
        ...
        var _isStreampayEvent = require("./isStreampayEvent");

    }, { "./getWidgetUrl": "1spVz", "./makeSignatureString": "3JceE", "./isStreampayEvent": "aYuHq", "@parcel/transformer-js/src/esmodule-helpers.js": "gkKU3" }],
    "1spVz": [function(require, module, exports) {
        var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
        parcelHelpers.defineInteropFlag(exports);
        ...
        const getOrigin = (environment) => {
            switch (environment) {
                case 'production':
                    return 'https://widget.streampayment.app';
                case 'development':
                    return 'https://dev-widget.streampayment.app';
                case 'stage':
                    return 'https://stage-widget.streampayment.app';
                default:
    ...
    "aYuHq": [function(require, module, exports) {
        var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
        parcelHelpers.defineInteropFlag(exports);
        parcelHelpers.export(exports, "isStreampayEvent", () => isStreampayEvent);
    ...
    "hqJQc": [function(require, module, exports) {
        var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
        parcelHelpers.defineInteropFlag(exports);
...
}, ["fxuAQ", "laZXI"], "laZXI", "parcelRequire6648")
