import {getWidgetUrl, isStreampayEvent} from '../helpers';
...
import {EventType, StreampayEventMap, WidgetMessageEventData} from '..';
...
export class StreamPay {
  ...
  public addListener<K extends keyof StreampayEventMap>(
    type: K,
    listener: (data: StreampayEventMap[K]['payload']) => void,
  ): void {
